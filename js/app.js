import { CONFIG, isConfigurationReady, readableError, setText, showToast } from "./utilities.js?v=1.3.0";
import { signInWithMicrosoft, signOut, getCurrentSession, onAuthStateChange, establishAuthorisedSession } from "./auth.js?v=1.3.0";
import { loadDashboard } from "./dashboard.js?v=1.3.0";
import { activateNavigation, initialiseNavigation } from "./navigation.js?v=1.3.0";
